   ...
   <section className="text-gray-600 body-font relative 2xl:max-w-screen-xl xl:max-w-screen-lg lg:max-w-screen-lg items-center px-3 py-3">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a href="mailto:info@commatech.in" className="text-indigo-500 leading-relaxed">
                info@commatech.in
              </a>
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
              <p className="leading-relaxed">+91-9307924239</p>
            </div>
          </div>
        </div>
        <div className="lg:w-1/3 md:w-1/2 px-4 bg-white py-3 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <p className="leading-relaxed mb-5 text-gray-600">Get in touch with us for professional makeup services by filling out the form below. </p>
      ...
      <button className="text-white bg-amber-500 border-0 py-2 px-6 focus:outline-none hover:bg-amber-600 text-lg">Button</button>
