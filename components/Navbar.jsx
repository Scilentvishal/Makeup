...
const Navbar = () => {
    ...
    return (
        <div className="h-[50px] md:flex bg-black text-white items-center align-middle fixed top-0 right-0 left-0 z-40 justify-between md:py-0 py-4 border-b-2 border-gray-400  lg:px-24 px-5">
            <h1><Link href="/" className='text-center'>Commatech</Link></h1>
            ...
            <ul onClick={() => setOpen(false)} className="md:hidden transition-all duration-100 fixed h-[calc(100vh-50px)] w-1/2 bg-black top-12 m-0 p-0 font-bold text-gray-300 list-none bottom-0 flex flex-col items-center justify-around z-50" style={{ right: open ? "0px" : "-50vw" }}>
