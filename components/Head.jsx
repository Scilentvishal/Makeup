  ...
  return (
    <div className="flex flex-col-reverse relative lg:flex-row lg:justify-center items-center lg:h-[90vh]">
      <div className="lg:w-1/2 py-3 px-3 max-w-screen-md">
        <h1 className="lg:text-6xl text-4xl font-mono font-black text-amber-500">
          Welcome to Shelby&apos;s
          <br />
          Passion to Beautify Makeovers
        </h1>
        <p className="my-4 text-xl text-gray-400">
          Makeup Artist, Educator & Entrepreneur
        </p>
        <button className="font-mono bg-amber-500 border-l-4 border-white hover:bg-amber-700 text-white font-semibold hover:text-white py-4 px-6 ">
